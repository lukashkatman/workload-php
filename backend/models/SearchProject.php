...
/**
 * SearchProject represents the model behind the search form about `backend\models\Project`.
 */
class SearchProject extends Project
{
    ...
    public function rules()
    {
        return [
            [['project_id'], 'integer'],
            [['project_name', 'project_detail', 'project_created_date', 'project_deadline'], 'safe'],
        ];
    }
